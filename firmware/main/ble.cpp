...
bool
BleServer::is_connected () const {
	return connected_;
}

void
BleServer::register_app () {
...
void
BleServer::gatts_event_handler (esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if,
...
void
BleServer::gap_event_handler (esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t* param) {
	if (instance_) {
...
void
BleServer::on_gatts_event (esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if,
						   esp_ble_gatts_cb_param_t* param) {
	switch (event) {
...
void
BleServer::on_gap_event (esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t* param) {
	switch (event) {
