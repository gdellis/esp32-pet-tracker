...
class DeepSleep {
  public:
	 ...
	 */
	static void
	sleep (uint64_t duration_us = DEFAULT_WAKEUP_TIME_US) {
	 ...
	 */
	static void
	enable_timer_wakeup (uint64_t duration_us) {
	 ...
	 */
	static void
	enable_gpio_wakeup (gpio_num_t gpio_num, esp_sleep_ext1_wakeup_mode_t mode) {
	 ...
	 */
	static bool
	is_wakeup_caused_by_timer (void) {
